...
in entità distinte tra loro in modo da favorire il lavoro di gruppo (non si lavora mai sullo stesso componente simultaneamente, ma si può 
lavorare insieme su livelli separati). Inoltre, essendo Angular un framework che impone una separazione in moduli del codice [citare], una divisione
così fatta incoraggia il riusco del codice ovviamente. %fare diagramma di sequenza e un esempio

%Tra ch 1 e 2 bisognerebbe aggiungere altre 8 pagine
...
dell'anno accademico precedente (che per gli appelli precedenti si era obbligati a fare perchè altrimenti alcuni studenti non vedrebbero
l'appello) perchè a fine gennaio termina l'anno e per qualche motivo burocratico non si può fare, dunque InfoStud restituisce un errore e 
il professore non ne conosce neanche il motivo.

Viste le criticità però esiste una funzione che i professori apprezzano, ovvero quella della duplicazione del verbale.
