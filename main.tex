...
Nel precedente capitolo ho descritto le riposte che sono state date al sondaggio ed ho effetivamente trascritto quali sono i margini di miglioramento. Abbiamo visto che una buona percentuale dei partecipanti al sondaggio non è contenta dell'interfaccia desktop e mi ha dato dei buoni spunti su cui lavorare, come l'aggiunta di orario e luogo d'esame. Ma per ora mi concentrerò soltanto nel miglioramento dell'esperienza utente.

In questo capitolo descriverò i requisiti che ho individuato e le varie fasi di progettazione che ho intrapreso per la realizzazione finale della funzionalità di apertura del verbale.

\subsection{Requisiti}
Raccolte ed organizzate le risposte al sondaggio, ho individuato i seguenti requisiti \footnote{Non ordinati.}:
\begin{enumerate}
...
\subsection{Valutazione dell'interfaccia mobile}
